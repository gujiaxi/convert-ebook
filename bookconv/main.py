...
def kindle_gen_bin():
    ...
    if system_name == "Windows":
        return os.path.abspath(os.path.join(bundle_dir, "bin/kindlegen.exe"))
    elif system_name == "Linux":
        return os.path.abspath(os.path.join(bundle_dir, "bin/kindlegen-linux"))
    elif system_name == "Darwin":
        return os.path.abspath(os.path.join(bundle_dir, "bin/kindlegen-macos"))
    else:
        print_log("不支持的操作系统")
